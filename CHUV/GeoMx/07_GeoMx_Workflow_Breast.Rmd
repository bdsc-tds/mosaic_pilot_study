...
source(paste0(absolute_path_cur, "spatial/env/ydong/Owkin_Pilot/Code/GeoMx/Manuscript/GeoMx_init.R"))
read_path <- paste0(absolute_path_cur, "owkin_pilot/Owkin_Pilot_Intermediate/GeoMx/GeoMx_test_norm/")
# save_path <- paste0(absolute_path_cur, "owkin_pilot/Owkin_Pilot_Intermediate/GeoMx/GeoMx_Final_Qcd/")
library(ggspavis)
library(patchwork)
```
