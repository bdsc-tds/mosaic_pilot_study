...
br_level1_5_cellcolors <- c("#FFDAB9", "#FFC125",     "#B452CD", "#388E8E", "#00BFFF", "#EEEE00")
...
geo_level4breast_B3_ROI_plot$AOIn_cf = factor(geo_level4breast_B3_ROI_plot$AOIn_cf,
                                              levels = rev(c("1_Malignant",  "1_Other",      "2_Malignant",  "2_Other",      "2_T_cells",    "3_Malignant",  "3_Other",      "4_T_cells",    "5_Malignant",  "5_Other",      "6_Malignant",
                                                         "6_Other",      "7_PanCK-",     "8_Malignant",  "8_Other",      "8_T_cells",    "9_Malignant",  "9_Other",      "10_Malignant", "10_Other",     "11_Malignant", "11_Other")))
p <- ggplot(geo_level4breast_B3_ROI_plot, aes(fill=CellType, y=Fraction, x=AOIn_cf)) + 
