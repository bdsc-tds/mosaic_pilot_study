...
results_efit<- limma::decideTests(efit, p.value = 0.05, lfc = 0)
...
save_path <- "/work/PRTNR/CHUV/DIR/rgottar1/owkin_pilot/Manuscript_revision/Fig5_Geo_B3/Geo_Vis_Chrom/DiffDE_nofilter"
# write.csv(results, file.path(save_path, "Geo_3vs6_DE_lfc0.csv"))
write.csv(results, file.path(save_path, "Geo_3vs6_DE_lfc0_pval1.csv"))
