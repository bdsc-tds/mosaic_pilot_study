...
# write.csv(results, file.path(save_path, "voom_B3malig_DE_3vs6_lfc0_BH.csv"))
write.csv(results, file.path(save_path, "voom_B3malig_DE_3vs6_lfc1_BH.csv"))

# pdf(file = file.path(save_path, "voom_B3malig_volcano_3vs6_lfc0_BH.pdf"),
pdf(file = file.path(save_path, "voom_B3malig_volcano_3vs6_lfc1_BH.pdf"),
    width = 11.5,
    height = 12)
print(p)
dev.off()
...
DE_results <- read.csv(file.path(save_path, 
                                 # "voom_B3malig_DE_3vs6_lfc0_BH.csv"
                                 "voom_B3malig_DE_3vs6_lfc1_BH.csv"
),
row.names = 1)
...
# plot_title = "Geo_B3_DE_Pathway_159_pink_3vs6_lfc0_BH.pdf"
plot_title = "Geo_B3_DE_Pathway_159_pink_3vs6_lfc1_BH.pdf"
...
# plot_title = "Geo_B3_DE_Pathway_14_blue_3vs6_lfc0_BH.pdf"
plot_title = "Geo_B3_DE_Pathway_14_blue_3vs6_lfc1_BH.pdf"
pdf(file = file.path(save_path, plot_title),
    width = 7,
    height = 5.5)
print(p)
